...
- **Statistiques** — un tableau de bord chiffré de la collection : nombre de disques / artistes / labels, part enrichie, avec paroles, notés, en concert, masqués, et des classements (par décennie, genres, **artistes les plus présents**, labels, pays de pressage, formats, répartition des notes) — chaque barre renvoie vers la recherche filtrée correspondante.
